                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border-spacing:0;">
                      <tr>
                        ...
                        <td style="padding: 0; width: 50%" align="right">
                          ...
                          <a
                            href="#">
                            <img src="https://i.ibb.co/xGSgDfF/25231.png"
                              alt="Not Found" class="social-icon" width="20" height="20" style="margin-left: 12px" />
                          </a>
                          <a
                            href="#">
                            <img src="https://i.ibb.co/xhyPr5g/38669.png"
                              alt="Not Found" class="social-icon" width="20" height="20" style="margin-left: 12px" />
                          </a>
                        </td>
                      </tr>
                    ...
                    <table>
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                            Gracias por registrarte a MyShop para vivir la experiencia del mercado online.
                            Te invitamos a que seleciones tus primeros productos y agregarlos al carrito.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                          <p>Atentamente, <br />Equipo de MyShop</p>
                          </p>
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table style="width:100%">
                            <tr>
                              <td
                                ...
                                <a href="https://api-e-commerce-production.up.railway.app/"
